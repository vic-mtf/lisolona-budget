...
export default function useMicroProps () {
    ...
    }, [dispatch, audioStreamRef, localTrackRef, client, closeCustomSnackbar, enqueueCustomSnackbar]);
    ...
    return {handleToggleMicro, loading, micro, permission, handleDispatchAllowed};
}