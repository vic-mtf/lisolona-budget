    ...
    <>
      ...
      >
        <Typography
          ...
          align="center"
        >
          Merci d'avoir choisi notre service de vidéoconférence. 
          Votre appel est en cours dans un autre onglet. 
          Veuillez laisser l'onglet actuel ouvert pendant toute la durée de l'appel.
        </Typography>
        <MuiBox>
          <Button
            variant="outlined"
          ...
          >Retourner à la fenêtre d'appel en cours</Button>
        </MuiBox>
      </Backdrop>
    </>
  );
