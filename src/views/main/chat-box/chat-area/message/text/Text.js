...
export default function Text ({content, bgcolor}) {
    const text = htmlToText(content).trim();
    const [{ more, rootRef, step, MAX_HEIGHT }, { handleAddStep }] = useTextParams();
            ...
            >
              ...
              >
                ...
                <MuiBox
                  ...
                  color={bgcolor}
                  sx={{
                      background: 'linear-gradient(transparent, currentcolor, currentcolor)',
                      width: '100%',
                      '& > button': {
                        color: 'text.primary'
                      }
