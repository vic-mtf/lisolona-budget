    ...
    navigation === 3 && (
      <React.Fragment>
        ...
        <Box
          ...
          <LoadingList loading={notifications === null} lengthItem={9} />
          <EmptyContentMessage
            title='Aucune nouvelle notification'
            show={
              union(
                ...(notifications || [])?.map(({ children }) => [...children])
              )?.length === 0
            }
            description={`
                  ...
                  {index !== contacts.length - 1 ? (
                    ...
                    contacts?.length > 4 && (
                      <Button
                        ...
                        sx={{ mx: 2 }}
                        onClick={() =>
                          setCurrentList({ label, children, Item, indexItem })
                        }>
                        Voir plus...{" "}
                      </Button>
                    )
