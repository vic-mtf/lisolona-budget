...
export default function JoinMeetingByCode() {
  ...
  return (
    ...
    >
      ...
      <DialogTitle>Rejoindre une reunion</DialogTitle>
      <DialogContent>
        <DialogContentText>
          Pour accéder à la réunion en cours, saisissez le code unique de 9
          caractères fourni par l'hôte dans le champ ci-dessous. Veuillez
          vérifier l'exactitude du code, car il est indispensable pour
          participer à la réunion. Si vous rencontrez des difficultés pour
          trouver ou saisir le code, veuillez contacter l'hôte de la réunion
            ...
            onComplete={async (code) => {
              ...
              try {
                ...
                if (e?.code === 'ERR_NETWORK') {
                  alertData.message = (
                    <>
                      <b>Lisolo </b> peine à récupérer des données, votre
                      appareil n'est plus relié au réseau Internet.
                    </>
                  );
